...
@section('GambarJudul')
    <header class="position-relative overflow-hidden w-100"
        style="
        ...
        min-height: 100vh;
    ">
        <div class="container-fluid d-flex flex-column justify-content-center align-items-start h-100 text-white"
            style="background-color: rgba(0, 0, 0, 0.4); padding: 3rem;">
...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-2 order-lg-1">
                    ...
                    <img src="{{ asset('images/logo-srb-small.png') }}" alt="SRB Logo" class="img-fluid mb-4"
                        style="max-height: 3rem;">
                    <h4 class="fw-bold mb-4 h4" style="color: #212529;">STUDENT REPRESENTATIVE BOARD</h4>
                    <p class="text-muted small">
                        Student Representative Board (SRB) adalah lembaga perwakilan mahasiswa yang berfokus pada tiga pilar
                        utama: advokasi, pengawasan, dan legislasi. Kami menjembatani komunikasi antara mahasiswa dan pihak
                        otoritas kampus, memastikan setiap suara didengar dan setiap kebijakan transparan.
                    </p>
                    <a href="{{ url('/profil') }}" class="btn btn-sm text-decoration-underline mt-3"
                        style="color: #a38d58; border: 1px solid #a38d58; background-color: transparent;">LEARN MORE</a>
                </div>
                <div class="col-lg-6 text-center order-1 order-lg-2 mb-4 mb-lg-0">
                    <img src="{{ asset('images/logo-srb-large.png') }}" alt="Logo SRB" class="img-fluid p-4"
                        style="max-width: 65%;">
                </div>
            </div>
        </div>
    ...
    <section class="py-5 py-md-5 text-white"
        style="
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="p-3 border border-warning h-100" style="background-color: rgba(0, 0, 0, 0.7);">
                        ...
                        <p class="small">Kami menjunjung tinggi etika dan kejujuran dalam setiap tindakan, menjadikan
                            kepercayaan mahasiswa sebagai prioritas utama kami.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="p-3 border border-warning h-100" style="background-color: rgba(0, 0, 0, 0.7);">
                        ...
                        <p class="small">Anggota kami terlatih untuk menganalisis masalah secara mendalam dan menyajikan
                            solusi yang konstruktif.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="p-3 border border-warning h-100" style="background-color: rgba(0, 0, 0, 0.7);">
                        ...
                        <p class="small">Kami memiliki jalur komunikasi yang jelas dengan pihak otoritas untuk memastikan
                            aspirasi terealisasi dengan baik.</p>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="p-4 border h-100" style="background-color: #e6e6e6;">
                        ...
                        <p class="small text-muted">Kami menjembatani sengketa antara mahasiswa dan lembaga, memastikan
                            penyelesaian yang adil dan sesuai aturan.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="p-4 border h-100" style="background-color: #dcdcdc;">
                        ...
                        <p class="small text-muted">Memberikan peninjauan hukum atas peraturan organisasi dan mendampingi
                            mahasiswa dalam aspek legislatif.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="p-4 border h-100" style="background-color: #e6e6e6;">
                        ...
                        <p class="small text-muted">Melakukan fungsi pengawasan terhadap kinerja lembaga internal kampus dan
                            memastikan akuntabilitas program kerja.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                    ...
                    <p class="text-muted mb-4 small">Sebagai perwakilan mahasiswa, layanan kami berfokus pada dukungan
                        penuh untuk hak dan kebutuhan Anda:</p>
                    ...
                    <ul class="list-unstyled">
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div>
                                ...
                                <p class="small text-muted">Sampaikan keluhan dan masukan terkait fasilitas, akademik, dan
                                    pelayanan kampus.</p>
                            </div>
                        </li>
                        <li class="d-flex align-items-start mb-3">
                        ...
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div>
                                ...
                                <p class="small text-muted">Pengajuan peninjauan dan konsultasi mengenai peraturan
                                    organisasi dan kampus.</p>
                            </div>
                        </li>
                    </ul>
                </div>
